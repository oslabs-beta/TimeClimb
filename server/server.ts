...
import logData from './controllers';
import stepFunctionController from './stepFunctionController';
...
app.get('/getStateMachines-aws', stepFunctionController.listStateMachines, (req:Request, res:Response)=> {
