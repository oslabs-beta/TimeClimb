...
averageLatenciesRouter.get(
  "/:step_function_id/days", averageLatenciesApiController.getAverageLatenciesDaily,
  (req: Request, res:Response): void => {
...
averageLatenciesRouter.get(
  "/:step_function_id/weeks", averageLatenciesApiController.getAverageLatenciesWeekly,
  (req: Request, res:Response):void => {
...
averageLatenciesRouter.get(
  "/:step_function_id/months", averageLatenciesApiController.getAverageLatenciesMonthly,
  (req: Request, res: Response): void => {
    console.log(res.locals.monthlyAvgs.length)
